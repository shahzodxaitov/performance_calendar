...
export async function GET() {
  ...
  // BOLT OPTIMIZATION: Index team members by ID to replace O(N*M) search with O(N+M) lookup.
  // This ensures reminder processing scales linearly with the number of tasks.

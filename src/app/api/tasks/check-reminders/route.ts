...
/**
 * ⚡ Bolt: Refactored to return Promise<boolean> and handle errors.
 * This allows state updates to be conditional on successful notification.
 */
...
export async function GET() {
  // ⚡ Bolt: Cache current timestamp to ensure consistency and avoid redundant Date object creation.
  const now = new Date();
  ...
  // ⚡ Bolt: Use a Map for O(1) team member lookups.
  ...
  // ⚡ Bolt: Execute all notifications in parallel to avoid sequential network latency.

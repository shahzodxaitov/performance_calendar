...
export async function GET() {
  ...
  // ⚡ Bolt: Use a Map for O(1) lookup of team members by ID instead of O(N) .find() inside the loop
  ...
  for (const task of tasks) {
    ...
    // ⚡ Bolt: Constructing deadline string and calculating time difference
  ...
  // ⚡ Bolt: Send all notifications in parallel for maximum speed

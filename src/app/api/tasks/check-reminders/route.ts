...
export async function GET() {
  // ⚡ Bolt: Hoist timestamp and create a Map to optimize lookups from O(N*M) to O(N+M)
  const now = new Date();
  ...
  // ⚡ Bolt: Execute notifications in parallel using Promise.allSettled to avoid serial bottleneck

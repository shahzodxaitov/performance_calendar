...
export default function CRMPage() {
  ...
  // AmoCRM display stats configuration memoized to avoid allocations on frequent re-renders (e.g. chart hovers)
  ...
  // Memoize new leads count calculation to prevent O(N) array filtering during frequent chart renders
